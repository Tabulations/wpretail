...
class WPRetail_Install {
	...
	private static function get_schema() {
		...
		$tables = "
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_currencies(
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_business (
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				name text NOT NULL,
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_tax_groups (
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				name text NOT NULL,
				status BOOLEAN DEFAULT 1,
				created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_business_location(
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				...
				invoice_scheme INT NULL,
				invoice_layout_pos INT NULL,
				invoice_layout_sale INT NULL,
				selling_price_group INT NULL,
				status BOOLEAN DEFAULT 1,
				created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
				updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
			) $charset_collate;
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_categories(
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				name VARCHAR(256),
				business_id BIGINT UNSIGNED NOT NULL,
				FOREIGN KEY(business_id) REFERENCES {$wpdb->prefix}wpretail_business(id) ON DELETE CASCADE,
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_brands(
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				business_id BIGINT UNSIGNED NOT NULL,
				FOREIGN KEY(business_id) REFERENCES {$wpdb->prefix}wpretail_business(id) ON DELETE CASCADE,
				name VARCHAR(256),
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_warranties(
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				name VARCHAR(256),
				business_id BIGINT,
				description VARCHAR(200) NULL,
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_tax_rates(
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				name VARCHAR(256),
				business_id BIGINT,
				description VARCHAR(200) NULL,
				rate INT NULL,
				for_group BOOLEAN DEFAULT 0,
				duration BIGINT,
				duration_type ENUM('days','months','years'),
				status BOOLEAN DEFAULT 1,
				created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
			...
			CREATE TABLE IF NOT EXISTS {$wpdb->prefix}wpretail_products(
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
				name VARCHAR(256),
